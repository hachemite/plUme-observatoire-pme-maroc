...
| `5.61.209.224` | ip | `ddos_extortion` | `high` | `abuseipdb` | 2 |
| `103.204.167.40` | ip | `ddos_extortion` | `high` | `abuseipdb` | 2 |
| `45.148.10.151` | ip | `ddos_extortion` | `high` | `abuseipdb` | 2 |
| `107.189.28.96` | ip | `ddos_extortion` | `high` | `abuseipdb` | 2 |
| `213.176.26.95` | ip | `ddos_extortion` | `high` | `abuseipdb` | 2 |
