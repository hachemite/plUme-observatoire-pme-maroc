# %% [markdown]
# # Observatoire PME Maroc — Exploration des données collectées (Jalon 1)
...
# %% [markdown]
# ## 4. Qualité des données (Validation des valeurs nulles)

# %%
# Validation de l'absence de valeurs nulles sur les champs requis du schéma ThreatEvent
...
# %% [markdown]
# ## 5. Synthèse des livrables du Jalon 1
...
# %%
df['category'].value_counts().plot(kind='bar', title='Threat events by category')

# %%
df['status'].value_counts().plot(kind='bar', title='online vs offline')
